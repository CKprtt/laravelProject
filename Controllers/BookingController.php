...
class BookingController extends Controller
{
    public function indexBooking()
    {
        ...
        return view('bookings.indexBooking', ['hallBookings' => $hallBookings, 'nonHallBookings' => $nonHallBookings,'zones'=> $zones,]);
    }
    ...
    public function storeZone(Request $request, $eventId)
{
    ...
    $b->qty = 1;
    $b->save();
    return redirect()->route('bookings.indexBooking')->with('ok', 'จองสำเร็จ: ' . $tracking);
}
