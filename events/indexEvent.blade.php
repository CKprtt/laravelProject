      ...
      <div class="card">
        <div class="poster">
          @if(isset($e->poster_path))
            <img src="{{ $e->poster_path ? asset($e->poster_path) : asset('images/sample-event.jpg') }}" alt="poster" style="width:180px; border-radius:6px;">
          @else
        ...
        <div class="content">
          ...
          <a class="btn" href="{{ route('events.showEvent', $e->id) }}">เพิ่มเติม</a>
        </div>
      </div>
    @endforeach
  @endif
